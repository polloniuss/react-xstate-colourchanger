import type { ActorRef, Interpreter, SCXML, SpawnedActorRef, State, StateMachine } from 'xstate';
...
export declare type InspectReceiver = SpawnedActorRef<ReceiverCommand, ParsedReceiverEvent>;
